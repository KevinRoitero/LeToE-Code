...
def fun(args):
    ...
    train.to_pickle('./_pickles/TCA-all/train{}-eval{}-train.pickle'.format(len(others_coll), collection_eval))
    test.to_pickle('./_pickles/TCA-all/train{}-eval{}-test.pickle'.format(len(others_coll), collection_eval))
